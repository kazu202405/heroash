        ...
        {features.map((feature, index) => (
          ...
          >
            <div
              ...
              `}
            >
              <span className="absolute top-4 right-4 text-5xl font-extralight text-white/5">
                {feature.number}
              </span>
...
// デスクトップ用の横スクロール
function DesktopLayout({ sectionRef, containerRef }) {
  return (
    <div
      ref={containerRef}
    ...
    >
      ...
      {features.map((feature, index) => (
        <div
          key={index}
          className="flex-shrink-0 w-[35vw] h-screen flex items-center justify-center px-4"
        >
          <TiltCard
  ...
  return (
    ...
    >
      ...
      {isMobile ? (
        ...
        <DesktopLayout sectionRef={sectionRef} containerRef={containerRef} />
      )}
    </section>
  )
}
